...
void setupLocator() {
  ...
  // Repositories
  locator.registerLazySingleton(() => LessonRepository(locator<LessonService>()));
  locator.registerLazySingleton(() => PronunciationRepository(locator<PronunciationService>()));
  locator.registerLazySingleton(() => SpeechRepository(locator<SpeechService>()));
  
  // Providers
  // locator.registerLazySingleton(() => AuthProvider());
  locator.registerLazySingleton(() => LessonProvider(locator<LessonRepository>()));
  locator.registerLazySingleton(() => PronunciationProvider(locator<PronunciationRepository>()));
  locator.registerLazySingleton(() => SpeechProvider(locator<SpeechRepository>()));
}